...
$tecnico = new Tecnico("Carlos Silva", 3000, "T123", 500);
$tecnico->exibeDados();

echo "\n FUNCIONÁRIO ADMINISTRATIVO (NOITE) \n";
$admNoite = new Administrativo("Ana Paula", 2800, "A456", "noite", 300);
$admNoite->exibeDados();

echo "\n FUNCIONÁRIO ADMINISTRATIVO (DIA) \n";
$admDia = new Administrativo("João Pedro", 2800, "A789", "dia");
$admDia->exibeDados();
