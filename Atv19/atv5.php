...
$admin = new Administrativo("Maria", 3000, "A123");
$tecnico = new Tecnico("João", 3200, "T456");
...
echo "\n b) Cachorro e Gato \n";
$dog = new Cachorro("Rex", "Vira-lata");
$cat = new Gato("Mimi", "Siamês");
echo $dog->late() . "\n";
echo $dog->caminha() . "\n";
echo $cat->mia() . "\n";
echo $cat->caminha() . "\n";
...
$miseravel = new Miseravel("João", 50);
...
if ($tipoImovel == 1) {
    $novo = new Novo("Rua Bela Vista", 300000, 25000);
